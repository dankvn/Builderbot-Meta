...
import { getFullCurrentDate } from "src/utils/currentDate.js";
...
const flowSchedule = addKeyword(EVENTS.ACTION).addAction(async (ctx, { state, flowDynamic }) => {
    ...
    const { date } = await g4f.desiredDateFn([
        {
            role: 'system',
